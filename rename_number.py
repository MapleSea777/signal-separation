...
for filename in os.listdir(folder_path):
    if filename.endswith(".wav"):
        ...
        new_filename = new_filename.replace("Target", "T")
        new_filename = new_filename.replace("No", "")
        new_filename = new_filename.replace("Cycle", "")
        new_filename = new_filename.replace("Depth", "")
        new_filename = new_filename.replace("Group", "")
        new_filename = new_filename.replace("m", "")
